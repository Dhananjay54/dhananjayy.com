  ...
  return (
    ...
    ">
      ...
      <nav className="flex items-center justify-center">
        ...
        <CustomLink className="mx-4" href="/projects" title="Music" />
      </nav>
      <nav
      ...
      >
        ...
        <motion.a
          ...
          whileHover={{ y: -2 }}
          whileTap={{ scale: 0.9 }}
          aria-label="Checkout my IG profile"
        >
          <DribbbleIcon />
        </motion.a>
      ...
      </div>
    {
      ...
      <nav className="flex items-center justify-center flex-col">
        ...
        <CustomMobileLink toggle={handleClick} className="mx-4 lg:m-0 lg:my-2" href="/projects" title="Music" />
      </nav>
      <nav
